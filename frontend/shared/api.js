...
window.API = {
  ...
  auth: {
    ...
    updateMe: (payload) => api("/api/auth/me", { method: "PUT", body: payload, headers: clientHeaders() }),
  ...
  mechanic: {
    ...
    listReminders: () => api("/api/mechanic/reminders", { headers: mechanicHeaders() }),
    createReminder: (payload) => api("/api/mechanic/reminders", { method: "POST", body: payload, headers: mechanicHeaders() }),
    updateReminder: (id, payload) => api(`/api/mechanic/reminders/${id}`, { method: "PATCH", body: payload, headers: mechanicHeaders() }),
    ...
    getWhatsappSettings: () => api("/api/mechanic/whatsapp/settings", { headers: mechanicHeaders() }),
    updateWhatsappSettings: (payload) => api("/api/mechanic/whatsapp/settings", { method: "PUT", body: payload, headers: mechanicHeaders() }),
    testWhatsapp: () => api("/api/mechanic/whatsapp/test", { method: "POST", headers: mechanicHeaders() }),
    deactivateWhatsapp: () => api("/api/mechanic/whatsapp/deactivate", { method: "POST", headers: mechanicHeaders() }),
